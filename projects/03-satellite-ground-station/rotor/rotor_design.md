...
- En modo medio paso (el que usa el driver ULN2003 típico): $8152$ medios pasos/vuelta
- **Resolución angular: $360°/8152 ≈ 0.044°$ por paso**

Esto es muchísimo más fino de lo que hace falta: el ancho de haz de las antenas de este portfolio (QFH, Yagi) es de varios grados, así que el cuello de botella de precisión de apuntamiento nunca va a ser el motor.
