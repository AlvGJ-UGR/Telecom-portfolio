...
// IMPORTANTE: la libreria Stepper.h estandar de Arduino, con el
// constructor de 4 pines usado abajo, ejecuta secuencia de PASO
// COMPLETO (4 estados), no medio paso. Usar aqui el numero de medio
// paso (8152) haria que el motor girase el doble del angulo pedido en
// cada movimiento -- error de calibracion real, ya corregido.
const int STEPS_PER_OUTPUT_REV = 4076; // paso completo, calculado a partir de
                                        // la relación de reducción real 63.684:1
const float DEG_PER_STEP = 360.0 / STEPS_PER_OUTPUT_REV; // ~0.088 grados/paso
