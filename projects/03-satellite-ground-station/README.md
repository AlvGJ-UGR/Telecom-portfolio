...
- 📐 [`rotor/rotor_design.md`](rotor/rotor_design.md) — arquitectura, elección de motor, cálculo de resolución angular (0.088°/paso, paso completo) y limitaciones de par
