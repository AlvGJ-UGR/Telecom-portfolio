...
|---|---|---|---|---|
| 01 | [SDR Fundamentals: Spectrum + ADS-B](projects/01-sdr-fundamentals/) | 🔵 Planned | Live spectrum analyzer and aircraft tracking via ADS-B (1090 MHz) with a homemade collinear antenna | SDR, digital modulation, RF basics |
